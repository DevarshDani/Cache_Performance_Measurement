...
int main(int argc, char **argv)
{
  ...
  MR_L1 = (float) values[0]/values[1];
  printf("L1 data misses = %lli\nL1 total data cache access = %lli\nL1 data miss rate = %f\nexecution time = %lli\n", values[0], values[1], MR_L1, end_time - start_time);
  PAPI_reset(eventset);
  ...
  //printf("L1 data misses = %lli\nL1 total data cache access = %lli\nL1 data miss rate = %f\nrtime = %d\nptime = %d\n", values[0], values[1], MR_L1, rtime, ptime);
  printf("L1 data misses = %lli\nL1 total data cache access = %lli\nL1 data miss rate = %f\nexecution time = %lli\n", values[0], values[1], MR_L1, end_time - start_time);
  PAPI_reset(eventset);
